...
#define DEFAULT_EEPROM_SETTING_FILE_NAME "hi846_sm7250_default_eeprom_setting.fw"

#define HI846_SM7250_SENSOR_INFO_MODULE_ID_SUNNY		0x01
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_TRULY		0x02
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_A_KERR		0x03
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_LITEARRAY	0x04
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_DARLING	    0x05
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_QTECH		0x06
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_OFLIM		0x07
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_FOXCONN	    0x11
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_IMPORTEK	    0x12
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_ALTEK		0x13
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_ABICO		0x14
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_LITE_ON	    0x15
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_CHICONY	    0x16
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_PRIMAX		0x17
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_SHARP		0x21
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_MCNEX		0x31
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_HOLITECH		0x42
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_GOERTEK		0x54
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_SHINETECH	0x55
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_SUNWIN		0x56
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_JSL  		0x57
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_UNION		0x58
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_SEASONS		0x59
#define HI846_SM7250_SENSOR_INFO_MODULE_ID_MCNEX_LSC	0xA0

MODULE_Map_Table HI846_SM7250_MODULE_MAP[] = {
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_SUNNY,
		"sunny_hi846_sm7250", "sunny_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_TRULY,
		"truly_hi846_sm7250", "truly_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_A_KERR,
		"a_kerr_hi846_sm7250", "a_kerr_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_LITEARRAY,
		"litearray_hi846_sm7250", "litearray_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_DARLING,
		"darling_hi846_sm7250", "darling_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_QTECH,
		"qtech_hi846_sm7250", "qtech_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_OFLIM,
		"oflim_hi846_sm7250", "oflim_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_FOXCONN,
		"foxconn_hi846_sm7250", "foxconn_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_IMPORTEK,
		"importek_hi846_sm7250", "importek_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_ALTEK,
		"altek_hi846_sm7250", "altek_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_ABICO,
		"abico_hi846_sm7250", "abico_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_LITE_ON,
		"lite_on_hi846_sm7250", "lite_on_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_CHICONY,
		"chicony_hi846_sm7250", "chicony_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_PRIMAX,
		"primax_hi846_sm7250", "primax_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_SHARP,
		"sharp_hi846_sm7250", "sharp_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_MCNEX,
		"mcnex_hi846_sm7250", "mcnex_hi846_sm7250", NULL},
    { HI846_SM7250_SENSOR_INFO_MODULE_ID_HOLITECH,
		"holitech_hi846_sm7250", "holitech_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_GOERTEK,
		"goertek_hi846_sm7250", "goertek_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_SHINETECH,
		"shinetech_hi846_sm7250", "shinetech_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_SUNWIN,
		"Sunwin_hi846_sm7250", "Sunwin_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_JSL,
		"jsl_hi846_sm7250", "jsl_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_UNION,
		"union_hi846_sm7250", "union_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_SEASONS,
		"seasons_hi846_sm7250", "seasons_hi846_sm7250", NULL},
	{ HI846_SM7250_SENSOR_INFO_MODULE_ID_MCNEX_LSC,
		"mcnex_lsc_hi846_sm7250", "mcnex_lsc_hi846_sm7250", NULL},
};

#define HI846_SM7250_ID_ADDR 0x01
...
void hi846_sm7250_parse_module_name(struct cam_eeprom_ctrl_t *e_ctrl)
{
	uint16_t sensor_module_id = e_ctrl->cal_data.mapdata[HI846_SM7250_ID_ADDR];
	pr_info("%s :%d:sensor_module_id = %d \n",__func__, __LINE__, sensor_module_id);

	parse_module_name(&(e_ctrl->module_info[0]), HI846_SM7250_MODULE_MAP,
		sizeof(HI846_SM7250_MODULE_MAP) / sizeof(MODULE_Map_Table),
		sensor_module_id);
}

void hi846_sm7250_set_cali_info_valid(struct cam_eeprom_ctrl_t *e_ctrl)
{
...
int hi846_sm7250_validflag_check_eeprom(struct cam_eeprom_ctrl_t *e_ctrl)
{
	int  flag = 0;
...
int hi846_sm7250_checksum_eeprom(struct cam_eeprom_ctrl_t *e_ctrl)
{
	int  checksum = 0;
	int j;
	int rc = 0;
...
uint8_t *get_hi846_sm7250_default_setting_filename(struct cam_eeprom_ctrl_t *e_ctrl)
{
...
/**
 * hi846_sm7250_cam_eeprom_read_memory() - read map data into buffer
 ...
 */
static int hi846_sm7250_read_eeprom_memory(struct cam_eeprom_ctrl_t *e_ctrl,
...
static struct zte_eeprom_fn_t hi846_sm7250_eeprom_func_tbl = {
	.read_eeprom_memory = hi846_sm7250_read_eeprom_memory,
	.eeprom_match_crc = NULL,
	.eeprom_checksum = hi846_sm7250_checksum_eeprom,
	.validflag_check_eeprom = hi846_sm7250_validflag_check_eeprom,
	.parse_module_name = hi846_sm7250_parse_module_name,
	.set_cali_info_valid = hi846_sm7250_set_cali_info_valid,
	.read_id = NULL,
	.get_default_eeprom_setting_filename = get_hi846_sm7250_default_setting_filename,
};

static const struct of_device_id hi846_sm7250_eeprom_dt_match[] = {
	{ .compatible = "zte,hi846_sm7250_eeprom", .data = &hi846_sm7250_eeprom_func_tbl},
	{ }
};
MODULE_DEVICE_TABLE(of, hi846_sm7250_eeprom_dt_match);

static int hi846_sm7250_eeprom_platform_probe(struct platform_device *pdev)
{
	int32_t rc = 0;
	const struct of_device_id *match;

	pr_info("%s:%d %s E", __func__, __LINE__, pdev->name);
	match = of_match_device(hi846_sm7250_eeprom_dt_match, &pdev->dev);
	if (match)
...
static int hi846_sm7250_eeprom_platform_remove(struct platform_device *pdev)
{
	const struct of_device_id *match;
	int32_t rc = 0;
...
static struct platform_driver hi846_sm7250_eeprom_platform_driver = {
	.driver = {
		.name = "zte,hi846_sm7250_eeprom",
		.owner = THIS_MODULE,
		.of_match_table = hi846_sm7250_eeprom_dt_match,
	},
	.probe = hi846_sm7250_eeprom_platform_probe,
	.remove = hi846_sm7250_eeprom_platform_remove,
};

static int __init hi846_sm7250_eeprom_init_module(void)
{
	int rc = 0;

	rc = platform_driver_register(&hi846_sm7250_eeprom_platform_driver);
	pr_info("%s:%d platform rc %d\n", __func__, __LINE__, rc);
	return rc;
}

static void __exit hi846_sm7250_eeprom_exit_module(void)
{
	platform_driver_unregister(&hi846_sm7250_eeprom_platform_driver);

}

module_init(hi846_sm7250_eeprom_init_module);
module_exit(hi846_sm7250_eeprom_exit_module);
