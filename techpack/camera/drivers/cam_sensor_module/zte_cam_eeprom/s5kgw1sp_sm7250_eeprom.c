...
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_SUNNY		0x01
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_TRULY		0x02
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_A_KERR		0x03
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_LITEARRAY	0x04
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_DARLING	0x05
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_QTECH		0x06
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_OFLIM		0x07
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_FOXCONN	0x11
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_IMPORTEK	0x12
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_ALTEK		0x13
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_ABICO		0x14
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_LITE_ON	0x15
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_CHICONY	0x16
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_PRIMAX		0x17
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_SHARP		0x21
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_MCNEX		0x31
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_HOLITECH	0x42
#define S5KGW1SP_SENSOR_INFO_MODULE_ID_GOERTEK	0x54

MODULE_Map_Table S5KGW1SP_MODULE_MAP[] = {
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_SUNNY,
		"sunny_S5KGW1SP", "sunny_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_TRULY,
		"truly_S5KGW1SP", "truly_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_A_KERR,
		"a_kerr_S5KGW1SP", "a_kerr_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_LITEARRAY,
		"litearray_S5KGW1SP", "litearray_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_DARLING,
		"darling_S5KGW1SP", "darling_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_QTECH,
		"qtech_S5KGW1SP", "qtech_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_OFLIM,
		"oflim_S5KGW1SP", "oflim_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_FOXCONN,
		"foxconn_S5KGW1SP", "foxconn_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_IMPORTEK,
		"importek_S5KGW1SP", "importek_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_ALTEK,
		"altek_S5KGW1SP", "altek_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_ABICO,
		"abico_S5KGW1SP", "abico_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_LITE_ON,
		"lite_on_S5KGW1SP", "lite_on_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_CHICONY,
		"chicony_S5KGW1SP", "chicony_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_PRIMAX,
		"primax_S5KGW1SP", "primax_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_SHARP,
		"sharp_S5KGW1SP", "sharp_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_MCNEX,
		"mcnex_S5KGW1SP", "mcnex_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_HOLITECH,
		"HOLITECH_S5KGW1SP", "HOLITECH_S5KGW1SP", NULL},
	{ S5KGW1SP_SENSOR_INFO_MODULE_ID_GOERTEK,
		"GOERTEK_S5KGW1SP", "GOERTEK_S5KGW1SP", NULL},

};

#define DEFAULT_EEPROM_SETTING_FILE_NAME "s5kgw1sp_default_eeprom_setting.fw"

#define S5KGW1SP_ID_ADDR 0x1

#define S5KGW1SP_VCM_ID_ADDR 0x3
#define S5KGW1SP_RESERVED_ID_ADDR 0x0A
...
void S5KGW1SP_parse_module_name(struct cam_eeprom_ctrl_t *e_ctrl)
{
	uint16_t ratio = 0;
	uint16_t sensor_module_id = e_ctrl->cal_data.mapdata[S5KGW1SP_ID_ADDR];

	parse_module_name(&(e_ctrl->module_info[0]), S5KGW1SP_MODULE_MAP,
		sizeof(S5KGW1SP_MODULE_MAP) / sizeof(MODULE_Map_Table),
		sensor_module_id);

	/*The bad sunny module is compatibility here by zte*/
	if (sensor_module_id == S5KGW1SP_SENSOR_INFO_MODULE_ID_SUNNY) {
...
void S5KGW1SP_set_cali_info_valid(struct cam_eeprom_ctrl_t *e_ctrl)
{
...
int S5KGW1SP_validflag_check_eeprom(struct cam_eeprom_ctrl_t *e_ctrl)
{
	int  flag = 0;
...
int S5KGW1SP_checksum_eeprom(struct cam_eeprom_ctrl_t *e_ctrl)
{
	int  checksum = 0;
	int j;
	int rc = 0;
...
#if 0
uint32_t S5KGW1SP_read_vcm_id(struct cam_sensor_cci_client *cci_client)
{
	int rc = 0;
	struct cam_sensor_cci_client local_cci_client;
	uint32_t reg_addr = S5KGW1SP_VCM_ID_ADDR;
	uint32_t data = 0;
	uint32_t vcm_id = 0;
...
uint32_t S5KGW1SP_read_reserved_id(struct cam_sensor_cci_client *cci_client)
{
	int rc = 0;
	struct cam_sensor_cci_client local_cci_client;
	uint32_t reg_addr = S5KGW1SP_RESERVED_ID_ADDR;
	uint32_t data = 0;
...
uint8_t *get_S5KGW1SP_default_setting_filename(struct cam_eeprom_ctrl_t *e_ctrl)
{
	return DEFAULT_EEPROM_SETTING_FILE_NAME;
}

static struct zte_eeprom_fn_t S5KGW1SP_eeprom_func_tbl = {
	.read_eeprom_memory = NULL,
	.eeprom_match_crc = NULL,
	.eeprom_checksum = S5KGW1SP_checksum_eeprom,
	.validflag_check_eeprom = S5KGW1SP_validflag_check_eeprom,
	.parse_module_name = S5KGW1SP_parse_module_name,
	.set_cali_info_valid = S5KGW1SP_set_cali_info_valid,
	.read_id = S5KGW1SP_read_reserved_id,
	.get_default_eeprom_setting_filename = get_S5KGW1SP_default_setting_filename,
};

static const struct of_device_id S5KGW1SP_eeprom_dt_match[] = {
	{ .compatible = "zte,S5KGW1SP-eeprom", .data = &S5KGW1SP_eeprom_func_tbl},
	{ }
};
MODULE_DEVICE_TABLE(of, S5KGW1SP_eeprom_dt_match);

static int S5KGW1SP_eeprom_platform_probe(struct platform_device *pdev)
{
	int32_t rc = 0;
	const struct of_device_id *match;

	pr_info("%s:%d %s E", __func__, __LINE__, pdev->name);
	match = of_match_device(S5KGW1SP_eeprom_dt_match, &pdev->dev);
	if (match)
...
static int S5KGW1SP_eeprom_platform_remove(struct platform_device *pdev)
{
	const struct of_device_id *match;
	int32_t rc = 0;
...
static struct platform_driver S5KGW1SP_eeprom_platform_driver = {
	.driver = {
		.name = "zte,S5KGW1SP-eeprom",
		.owner = THIS_MODULE,
		.of_match_table = S5KGW1SP_eeprom_dt_match,
	},
	.probe = S5KGW1SP_eeprom_platform_probe,
	.remove = S5KGW1SP_eeprom_platform_remove,
};

static int __init S5KGW1SP_eeprom_init_module(void)
{
	int rc = 0;

	rc = platform_driver_register(&S5KGW1SP_eeprom_platform_driver);
	pr_info("%s:%d platform rc %d\n", __func__, __LINE__, rc);
	return rc;
}

static void __exit S5KGW1SP_eeprom_exit_module(void)
{
	platform_driver_unregister(&S5KGW1SP_eeprom_platform_driver);

}

module_init(S5KGW1SP_eeprom_init_module);
module_exit(S5KGW1SP_eeprom_exit_module);
